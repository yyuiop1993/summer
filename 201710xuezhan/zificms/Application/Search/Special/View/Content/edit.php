      ...
      <table width="100%">
         <tr>
          <td><div  style="text-align: center;"><input type='hidden' name='info[thumb]' id='thumb' value='{$info.thumb}'>
			...
			<img src='<if condition=" $info['thumb'] ">{$info.thumb}<else/>{$CurrentDomain}statics/images/icon/upload-pic.png</if>' id='thumb_preview' width='135' height='113' style='cursor:hand' /></a>
