      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="zificms" class="input"></td>
            <td><div id="J_install_tip_dbname"></div></td>
          </tr>
          <tr>
            <td class="tar">数据库表前缀：</td>
            <td><input type="text" name="dbprefix" id="dbprefix" value="zf_" class="input"></td>
		...
		<table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="sitename" value="zifi内容管理系统" class="input"></td>
          ...
          <tr>
            <td class="tar">关键词：</td>
            <td><input type="text" name="sitekeywords" value="zifi内容管理系统" class="input" autoComplete="off"></td>
            <td><div id="J_install_tip_sitekeywords"></div></td>
          </tr>
          <tr>
            <td class="tar">描述：</td>
            <td><input type="text" name="siteinfo" class="input" value="zifi内容管理系统,是一款完全开源免费的PHP+MYSQL系统.核心采用了Thinkphp框架等众多开源软件,同时核心功能也作为开源软件发布"></td>
        ...
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="manager" value="zhifeng" class="input"></td>
		  ...
		  <tr>
            ...
            <td><input name="testdata" type="checkbox" value="1" alt="测试数据需要安装在根目录下才可以完整体验-__,-!" title="测试数据需要安装在根目录下才可以完整体验-__,-!"/><span class="gray">默认测试数据，了解zificms！</span></td>
            <td><div id="J_install_tip_manager_email"></div></td>
          </tr>
        </table>
