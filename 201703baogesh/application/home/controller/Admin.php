...
class Admin extends Base{
    ...
    public function user_list(){
		...
		$where = '';
		if($keyword){
			$where['think_admin.username'] = array('like',"%".$keyword."%");
		}

		$list_data = Db::name("admin_user")->alias('a')->join(" think_admin_role role "," a.role_id = role.role_id ","left")->where($where)->paginate($this->limit);
