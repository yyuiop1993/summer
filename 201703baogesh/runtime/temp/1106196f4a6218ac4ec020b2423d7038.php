<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"E:\freehost\zhidui0301\web/application/wx\view\service\service_edit.html";i:1498528674;s:67:"E:\freehost\zhidui0301\web/application/wx\view\Common\baseHome.html";i:1493860094;}*/ ?>
<!DOCTYPE>
<html>
<head>
    ...
    <div class="content">
        ...
        <div class="map_form">
            ...
            <div class="form_item">
                ...
                <div class="input_block">
                    <input type="text" name="chuli_time" class="chuli_time" onClick="WdatePicker()" required="" placeholder="请选择处理时间"  value="<?php echo $data['chuli_time']; ?>"  autocomplete="off" /><span>*</span>
                </div>
            </div>
