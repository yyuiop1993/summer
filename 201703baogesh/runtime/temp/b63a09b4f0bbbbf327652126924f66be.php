<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"E:\freehost\zhidui0301\web/application/home\view\role\role_add.html";i:1495761041;s:69:"E:\freehost\zhidui0301\web/application/home\view\Common\baseHome.html";i:1495526082;}*/ ?>
<!DOCTYPE>
<html>
<head>
...
<span class="layui-breadcrumb">
    <a href="<?php echo url('role/role_list'); ?>">角色权限</a>
        ...
        <form class="layui-form" action="" id="role_from">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="role_name"  lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input role_name" >
                </div>
            </div>
...
layui.use(moudles, function(){  
    ...
    $(".button_sub").click(function(){
        ...
        $.post("<?php echo url('Role/role_add_ajax'); ?>",$('#role_from').serialize(),function(data){
            //console.log(data);
            if(data.status){ 
                layer.alert(data.msg,function(){
                    window.location.href = "<?php echo url('role/role_list'); ?>"
                });
            }else{
