...
<div class="container">
    <div class="line bouncein">
        <div class="xs6 xm4 xs3-move xm4-move">
            ...
            <form action="{:U('Public/tologin')}" method="post">
                ...
                <div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
                    ...
                    <div class="form-group">
                        <div class="field">
                           ...
                           <img src="{:U('Api/Checkcode/index','code_len=4&font_size=20&width=80&height=32&font_color=&background=')}" alt="" width="80" height="32" class="passcode" id="code_img" style="height:43px;cursor:pointer;" onClick="refreshs()" />  
