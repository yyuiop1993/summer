...
<link href="<?php echo ($config_siteurl); ?>statics/css/pintuer.css" rel="stylesheet" />
<link href="<?php echo ($config_siteurl); ?>statics/css/admin.css" rel="stylesheet" />
  ...
  <table width="100%" height="100%" style="table-layout:fixed;">
    <tr class="head">
      ...
      <td><div class="nav"> 
        ...
        <div class="login_info"><span class="mr10"><?php echo ($role_name); ?>：<?php echo ($userInfo["username"]); ?></span> <a href="<?php echo U('Public/logout');?>" class="button button-little bg-red"><span class="icon-power-off"></span> 注销登录</a><?php echo tag("view_admin_top_menu");?><a href="<?php echo ($Config["siteurl"]); ?>" class="button button-little bg-green" target="_blank"><span class="icon-home"></span> 前台首页</a><?php if(\Libs\System\RBAC::authenticate('Admin/Index/cache')){ ?><a href="javascript:;;" id="deletecache" class="button button-little bg-blue"  style="color:#FFF"><span class="icon-wrench"></span> 缓存更新</a><?php } ?></div></td>
    </tr>
    <tr class="tab">
      <th> <div class="search">
