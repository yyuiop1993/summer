...
<?php } ?>
  ...
  <form action="<?php echo U('Formguide/add');?>" method="post" name="myform" class="J_ajaxForm">
  ...
  <tbody>
	...
	<tr id="time_start" style="display:none;">
        ...
        <td><input type="text" name="setting[starttime]" id="starttime" value="<?php echo date('Y-m-d H:i');?>" class="J_datetime input" ></td>
	</tr>
