...
<body>
	...
	<link rel="stylesheet" href="<?php echo ($config_siteurl); ?>statics/default/css/mobileSelect.css">
...
<style type="text/css">
	...
	<div class="hearder-top"><a href="/index.php?a=lists&catid=1" class="bank"></a>工惠乐学<?php echo ($catname); ?></div>
	<div class="content yuyue1 clearfix">
		<div class="box box1">
			<img src="<?php echo ($config_siteurl); ?>statics/default/images/yuyue1.png" alt="">
		</div>
		<div class="box box2">
			<div class="tit">
				<div class="w">
	...
	<script type="text/javascript" src="<?php echo ($config_siteurl); ?>statics/default/js/mobileSelect.min.js"></script>
	<script type="text/javascript" src="<?php echo ($config_siteurl); ?>statics/default/js/select.js"></script>
	<!-- content end -->
	</body>
</html>
