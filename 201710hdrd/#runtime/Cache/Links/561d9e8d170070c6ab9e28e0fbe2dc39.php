...
<?php } ?>
  ...
  <table width="100%" cellspacing="0" >
		...
		<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
	       ...
	       <td align='center'><a href="<?php echo U('Links/termsedit',array('id'=>$vo['id']) );?>">编辑</a> | <a href="javascript:confirmurl('<?php echo U('Links/termsdelete',array('id'=>$vo['id']) );?>','确认要删除吗？')">删除</a></td>
