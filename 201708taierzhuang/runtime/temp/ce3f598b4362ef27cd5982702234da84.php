<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"/www/wwwroot/tez.lyzfrj.com/application/admin/view/vote/user_list.html";i:1504101579;s:71:"/www/wwwroot/tez.lyzfrj.com/application/admin/view/Common/baseHome.html";i:1504101306;}*/ ?>
<!DOCTYPE>
<html>
<head>
                ...
                <?php foreach($list_data as $v): ?> 
                    <tr>
                        ...
                        <td class="work_unit">
                            ...
                            <?php else: ?> 否
                            &nbsp;&nbsp;&nbsp;<button type="button" class="layui-btn layui-btn-danger  layui-btn-small set_on" data="<?php echo $v['id']; ?>" style="color: #fff" >设为已出票</button>
                            <?php endif; ?>     
                        </td>
