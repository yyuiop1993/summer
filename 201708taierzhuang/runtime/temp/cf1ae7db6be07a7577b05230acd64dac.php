<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/www/wwwroot/tez.lyzfrj.com/application/admin/view/vote/user_add.html";i:1506052640;s:71:"/www/wwwroot/tez.lyzfrj.com/application/admin/view/Common/baseHome.html";i:1504101306;}*/ ?>
<!DOCTYPE>
<html>
<head>
...
<form id="map" class="layui-form">
    ...
    <div class="content">
        ...
        <div class="map_form">
            ...
            <div class="form_item layui-form-item">
                <label class="form_label layui-form-label">出票时间：</label>
                <div class="input_block layui-input-block">
                    <input type="text" name="buy_time" class="buy_time layui-input" onClick="WdatePicker()" required="" placeholder="请点击选择出票时间" autocomplete="off" />
                </div>
            </div>
...
$(function(){
    ...
    $(".save_form").click(function(){
        ...
        if (!isNaN(number) && (number-0) ==0) {
         　layer.open({ content:'请输入出票数量!',btn: '好'});
            return false; 
        }
        /*if ((number-0)>2) {
