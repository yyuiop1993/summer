<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"D:\www\baogesh/application/admin\view\index\index.html";i:1495271857;s:54:"D:\www\baogesh/application/admin\view\Common\left.html";i:1493029740;}*/ ?>
<!DOCTYPE>
<html>
<head>
...
<div id="wrap">
    ...
    <div class="head_box">
        <div class="logo_img">
            <a href="/index.php"><img src="__IMG__/logo.jpg?v=1" ></a>
        </div>
    ...
    <div class="layui-side layui-side-bg layui-larry-side" lay-filter="side" >
        ...
        <ul class="layui-nav layui-nav-tree" lay-filter="test">
            <?php foreach ($list_menu as $k => $v) { if($v['id']==$menu_fid){ ?>
            ...
            <div class="layui-tab layui-tab-card main_tab_box" id="main_tab" lay-filter="page-tab" lay-allowclose="true">
                ...
                <div class="layui-tab-content" >
                    <div class="layui-tab-item layui-show">
                            <iframe src="/index.php/admin/index/main.html"></iframe>
                    </div>
                </div>
