<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"D:\www\201708gonghuidianying/application/admin\view\login\login.html";i:1503644568;}*/ ?>
<!DOCTYPE>
<html>
<head>
	...
	<div class="login_box">
		...
		<ul>
			...
			<li class="input_text input_code">
				...
				<span>
					<img src="<?php echo url('Common/verify'); ?>" onclick="this.src='/index.php/admin/common/verify?'+Math.random()" class="verify" >
				</span>
			</li>
