<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\freehost\zhidui0301\web/application/home\view\admin\user_edit.html";i:1495760938;s:69:"E:\freehost\zhidui0301\web/application/home\view\Common\baseHome.html";i:1495526082;}*/ ?>
<!DOCTYPE>
<html>
<head>
        ...
        <form class="layui-form" action="" id="admin_form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="username"  lay-verify="required" placeholder="请输入登录名" autocomplete="off" class="layui-input username" value="<?php echo $data['username']; ?>">
                </div>
            </div>
            ...
            <!-- 管理员不可修改 自己修改需要验证密码 -->
                ...
                <?php endif; endif; if(\think\Session::get('role_id') == '1'): ?>
            <div class="layui-form-item">
                <label class="layui-form-label">角色：</label>
                <div class="layui-input-block">
                    <select name="role_id" lay-verify="required">
                        <?php foreach($role_data as $v): if($v['role_id'] == $data['role_id']): ?>
                                <option value="<?php echo $v['role_id']; ?>" selected ><?php echo $v['role_name']; ?></option>
                            <?php else: ?>
            ...
            <input type="hidden" value="<?php echo $data['admin_id']; ?>" name="admin_id" class="admin_id" />
        </form>
...
$(".button_sub").click(function(){
    ...
    $.post("<?php echo url('admin/ajax_user_edit'); ?>",$('#admin_form').serialize(), function(data){
