<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\www\201708gonghuidianying/application/wx\view\index\index.html";i:1503890707;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
wx.config({
    ...
    wx.ready(function () {
        ...
        wx.onMenuShareTimeline({
            title: '时代三农网最具影响力直营店经理！', // 分享标题
            link: 'http://fks3ofzbf3u3dj2d.sdsnw.cn/header.html', // 分享链接
            imgUrl: 'http://fks3ofzbf3u3dj2d.sdsnw.cn/file/221.jpg', // 分享图标
            success: function () { 
                // 用户确认分享后执行的回调函数
            },
            cancel: function () { 
