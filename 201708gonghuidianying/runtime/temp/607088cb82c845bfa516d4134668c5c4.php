<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"E:\freehost\zhidui0301\web/application/home\view\service\service_list_show.html";i:1498618053;s:69:"E:\freehost\zhidui0301\web/application/home\view\Common\baseHome.html";i:1495526082;}*/ ?>
<!DOCTYPE>
<html>
<head>
...
<div class="view_status">
    <ul>
        ...
        <li class="<?php if($data['status2'] == 2): ?>on<?php endif; ?>">
            <h3><?php echo $role_data['1']['role_name']; ?></h3>
            <div class="status_yuan"></div>
            <div class="status_xian"></div>
        </li>

        <li class="<?php if($data['status3'] == 2): ?>on<?php endif; ?>">
            <h3><?php echo $role_data['2']['role_name']; ?></h3>
            <div class="status_yuan"></div>
            <div class="status_xian"></div>
        </li>

        <li class="<?php if($data['status4'] == 2): ?>on<?php endif; ?>">
            <h3><?php echo $role_data['3']['role_name']; ?></h3>
            <div class="status_yuan"></div>
            <div class="status_xian"></div>
        </li>

        <li class="<?php if($data['status5'] == 2): ?>on<?php endif; ?>">
            <h3><?php echo $role_data['4']['role_name']; ?></h3>
            <div class="status_yuan"></div>
            <div class="status_xian"></div>
        </li>

        <li class="<?php if($data['status6'] == 2): ?>on<?php endif; ?>">
            <h3><?php echo $role_data['5']['role_name']; ?></h3>
            <div class="status_yuan"></div>
            <div class="status_xian"></div>
        </li>

        <li class="<?php if($data['status7'] == 2): ?>on<?php endif; ?>">
            <h3><?php echo $role_data['6']['role_name']; ?></h3>
            <div class="status_yuan"></div>
            <div class="status_xian"></div>
        </li>
...
<!-- 只有能审批的人才可以进行修改 -->
<?php if(\think\Session::get('role_id') == 2 || \think\Session::get('role_id') == 3 || \think\Session::get('role_id') == 4 ||\think\Session::get('role_id') == 5 ||\think\Session::get('role_id') == 6 || \think\Session::get('role_id') == 7): ?>
...
<table class="layui-table" style="margin-top: 20px;">
    ...
    <tbody>
        ...
        <?php if(\think\Session::get('role_id') > 1 && \think\Session::get('role_id') < 7): ?>
        <tr>
            <th>选择审批人</th>
            <td>
