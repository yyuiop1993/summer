<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\www\201708gonghuidianying/application/admin\view\menu\menu_add.html";i:1495761060;s:72:"D:\www\201708gonghuidianying/application/admin\view\Common\baseHome.html";i:1503650615;}*/ ?>
<!DOCTYPE>
<html>
<head>
        ...
        <form class="layui-form" action="" id="menu_form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="menu_name"  lay-verify="required" placeholder="请输入菜单名称" autocomplete="off" class="layui-input menu_name">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="cc" lay-verify="required" placeholder="请输入controlla名称" autocomplete="off" class="layui-input cc">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="aa" lay-verify="required" placeholder="请填写function名称" autocomplete="off" class="layui-input aa">
                </div>
            </div>
...
$(".button_sub").click(function(){
    ...
    $.post("<?php echo url('menu/ajax_menu_add'); ?>",$('#menu_form').serialize(), function(data){
