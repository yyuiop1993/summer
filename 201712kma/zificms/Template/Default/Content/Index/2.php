...
<body>
	...
	<div class="header">
		...
		<div class="logo">
			<h1><a href="/index.php">河东区人民代表大会常务委员会</a></h1>
		</div>
		<div class="head-nav w clearfix">
			<div class="nav" id="nav">
				<ul>
					<li class="li01"><a href="/index.php" class="a1 current">首 页</a></li>
	...
	<div class="fixed fixed1 w clearfix">
		<div class="fixed-l fl">
			<div class="flexslider">
				<ul class="slides">
					<position action="position" catid="2" posid="1"  num='5' order="listorder desc">
		...
		<div class="fixed-c fl">
			...
			<ul>
				<content action="lists" catid="2"  order="updatetime DESC" num="9">
   					<volist name="data" id="vo">
		...
		<div class="fixed-r fr">
			...
			<div class="notice">
				...
				<div class="list_lh">
					<ul>
						<content action="lists" catid="42"  order="updatetime DESC" num="10">
							<volist name="data" id="vo">
								<li>
	...
	<div class="fixed fixed2 w clearfix">
		<div class="fl">
			<div class="box1">
				<ul>
					<li class="li1">
						<a href="http://60.213.12.250:82/LinYi_HeDongRD/Login.aspx?Soft=5&;login"  target="_blank">
							<img src="{$config_siteurl}statics/default/images/pt1.jpg" alt="河东区人大代表履职服务管理平台平台">
						</a>
					</li>
					<li>
						<a href="http://60.213.12.250:82/LinYi_HeDongRD/Login.aspx?Soft=1&;login" target="_blank">
							<img src="{$config_siteurl}statics/default/images/pt2.jpg" alt="河东区人大代表议案建议办理平台">
						</a>
					</li>
					<li>
						<a href="http://60.213.12.250:82/LinYi_HeDongRD/Web/DeputySpace.aspx"  target="_blank">
							<img src="{$config_siteurl}statics/default/images/pt3.jpg" alt="人大代表双联互动交流平台">
						</a>
					</li>
				</ul>
			</div>
								...
								<div class="bd">
									<volist name="data" id="vo" key='k'>
										<div class="bd-list  <if condition="$k eq 1">bd-list1</if>">
											<div class="special">
												<position action="position" posid="1" num='1' catid="$vo['catid']" order="listorder DESC" >
													<volist name="data" id="vo">
														<div class="pic">
											...
											<ul>
												<content action="lists" catid="$vo['catid']"  order="listorder DESC" num="7">
								   					<volist name="data" id="vo">
								...
								<div class="bd">
									<volist name="data" id="vo" key='k'>
										<div class="bd-list  <if condition="$k eq 1">bd-list1</if>">
											...
											<ul>
												<content action="lists" catid="$vo['catid']"  order="updatetime DESC" num="7">
								   					<volist name="data" id="vo">
								   						<li><a href="{$vo.url}">{$vo.title|str_cut=###,20}</a><span>{$vo.updatetime|date="Y-m-d",###}</span></li>
													</volist>
												</content>	
			...
			<div class="box2">
					...
					<div class="tab">
						<div class="bd">
							<div class="bd-list bd-list1">
								<ul>
									<content action="lists" catid="3"  order="updatetime DESC" num="8">
					   					<volist name="data" id="vo">
					   						<li><a href="{$vo.url}">{$vo.title|str_cut=###,20}</a><span>{$vo.updatetime|date="Y-m-d",###}</span></li>
										</volist>
									</content>	
				...
				<div class="fr box2-fl">
					<div class="tit"><a href="{:getCategory(8,'url')}" class="noti">镇街人大</a><a href="{:getCategory(41,'url')}" class="more"><i class="c-red">+</i> 更多</a></div>
					<div class="tab">
						<div class="bd">
							<div class="bd-list bd-list1">
							    <position action="position" posid="1" num='1' catid="8" order="updatetime DESC" >
							    	<volist name="data" id="vo">
										<div class="special">
											<div class="pic">
												<a href="{$vo.data.url}"><img src="{$vo.data.thumb}" alt=""></a>
								...
								<ul>
									<content action="lists" catid="8"  order="updatetime DESC" num="5">
					   					<volist name="data" id="vo">
					   						<li><a href="{$vo.url}">{$vo.title|str_cut=###,20}</a><span>{$vo.updatetime|date="Y-m-d",###}</span></li>
										</volist>
									</content>	
						...
						<div class="fr-tab-bd">
							<volist name="data" id="vo" key='k'>
								<ul <if condition="$k eq 1"> class="ul1" </if> >
									<content action="lists" catid="$vo['catid']"  order="updatetime DESC" num="3">
										<volist name="data" id="vo">
				...
				<div class="fixed2-fr-tab">
					<content action="category" catid="9" num="3"  order="listorder desc" >
						...
						<div class="fr-tab-bd">
							<volist name="data" id="vo" key='k' >
								<ul <if condition="$k eq 1"> class="ul1" </if> >
									<content action="lists" catid="$vo['catid']"  order="updatetime DESC" num="4">
										<volist name="data" id="vo">
											<li><a href="{$vo.url}">{$vo.title|str_cut=###,20}</a></li>
										</volist>
									</content>
	...
	<div class="link w clearfix">
		...
		<div class="fr">
			<select name="rd1" onchange="if(value!=''){window.open(this.options[this.selectedIndex].value);}else{return(false);}">
				...
				<get table="links" termsid="1" visible="1" >
					<volist name="data" id="vo">
			...
			<select name="rd2" onchange="if(value!=''){window.open(this.options[this.selectedIndex].value);}else{return(false);}">
				...
				<get table="links" termsid="2" visible="1" >
					<volist name="data" id="vo">
						<option  value="{$vo.url}">{$vo.name}</option>
					</volist>
				</get>
			...
			<select name="rd3" onchange="if(value!=''){window.open(this.options[this.selectedIndex].value);}else{return(false);}">
				...
				<get table="links" termsid="3" visible="1" >
					<volist name="data" id="vo">
						<option  value="{$vo.url}">{$vo.name}</option>
					</volist>
				</get>
