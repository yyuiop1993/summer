            ...
            <!-- <tr width="100%">
              <td width="100%" >
                <table width="100%">        -->
                 ...
                 <tr> <td align="right" width="15%">身份证</td>  <td  align="left" >{$res.card}</td></tr>
                 ...
                 <tr> <td align="right" width="15%">民族</td>  <td  align="left" >{$res.mz}</td></tr>
                 <tr> <td align="right" width="15%">次数</td>  <td  align="left" >{$res.cs}</td></tr>
                 <tr> <td align="right" width="15%">文化程度</td>  <td  align="left" >{$res.whcd}</td></tr>
                 <tr> <td align="right" width="15%">职业</td>  <td  align="left" >{$res.zy}</td></tr>
                 <tr> <td align="right" width="15%">工作单位</td>  <td  align="left" >{$res.gzdw}</td></tr>
                 <tr> <td align="right" width="15%">手机</td>  <td  align="left" >{$res.mob}</td></tr>
                 <tr> <td align="right" width="15%">地址</td>  <td  align="left" >{$res.add}</td></tr>
                 <tr> <td align="right" width="15%">邮编</td>  <td  align="left" >{$res.yb}</td></tr>
