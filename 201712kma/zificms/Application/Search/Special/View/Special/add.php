      ...
      <div>
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              <th>专题关键字：</th>
              <td><input type="text" name="special[keywords]" id="keywords" class="input length_5" value=""></td>
            </tr>
            <tr>
              <th>专题导读：</th>
            ...
            <tr>
              <th>统计代码：</th>
              <td><textarea name="special[code]" maxlength="255" style="width:300px;height:60px;"></textarea></td>
            </tr>
            <tr>
              <th>生成静态：</th>
