          ...
          <table width="100%" class="table_form ">
            <tr>
              ...
              <td><select name="setting[wappage_template]" id="page_template">
                  ...
                  <?php if(is_array($tp_page)): $i = 0; $__LIST__ = $tp_page;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>" <?php if($data['setting']['wappage_template'] == $vo ): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
									...
									button:[
										 {
											...
											name: '返回3G版栏目管理页',
											callback:function(){
												window.location.href = "<?php echo U('Wap/index',array('catid'=>$catid));?>";
												return true;
											}
										}
									]
