  ...
  <input type="hidden" value="1" name="search">
   ...
   <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
            ...
            <td width="6%" align="center"><?php echo ($vo["address"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["national"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["danwei"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["mail"]); ?></td>
