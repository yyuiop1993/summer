  ...
  <input type="hidden" value="1" name="search">
   ...
   <table width="100%" cellspacing="0">
        ...
        <?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr>
            ...
            <td width="6%" align="center"><?php echo ($vo["ip"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["wentijieda"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["shipin"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["quanlizunzhong"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["zhiqingyuanze"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["fuwutaidu"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["yantanjuzhi"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["jiaoliugoutong"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["jiangjie"]); ?></td>
            <td width="6%" align="center"><?php echo ($vo["jinianpin"]); ?></td>
            <td width="8%" align="center"><?php echo (date('Y-m-d H:i:s',$vo["add_time"])); ?></td>
            <!-- <td width="5%" align="center">
              <a href='<?php echo U("Pingtai/xianxue_detail",array("id"=>$vo[id]));?>'>查看详情</a> | 
              <a href="<?php echo U('Pingtai/xianxue_del',array('id'=>$vo['id']));?>" class="J_ajax_del">删除</a>
            </td> -->
