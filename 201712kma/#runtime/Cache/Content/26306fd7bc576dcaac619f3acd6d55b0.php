	...
	<div class="main clearfix">
		<div class="content clearfix" >
            ...
            <div class="contact_item contact_center">
                ...
                <ul>
                    <li>
                        <img src="<?php echo ($config_siteurl); ?>statics/default/images/contact_icon1.png">
                        &nbsp;&nbsp;www.kmataiquan.com
                    </li>
                    <li>
                        <img src="<?php echo ($config_siteurl); ?>statics/default/images/contact_icon2.png">
                        &nbsp;&nbsp;186-5391-0515
                    </li>
                    <li>
                        <img src="<?php echo ($config_siteurl); ?>statics/default/images/contact_icon3.png">
