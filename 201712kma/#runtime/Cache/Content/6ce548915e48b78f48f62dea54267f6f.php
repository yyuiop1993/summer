      ...
      <div>
        ...
        <div class="table_full">
          <table width="100%" class="table_form ">
            ...
            <tr>
              <th>英文栏目名称：</th>
              <td><input type="text" name="info[encatname]" id="encatname" class="input" value="<?php echo ($data["encatname"]); ?>"></td>
            </tr>
      ...
      <div style="display:none;">
        ...
        <?php if(is_array($extendList)): $i = 0; $__LIST__ = $extendList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          ...
          <?php switch($vo["type"]): case "input": ?><input type="text" class="input" style="<?php echo ($vo["setting"]["style"]); ?>"  name="extend[<?php echo ($vo["fieldname"]); ?>]" value="<?php echo ($data['setting']['extend'][$vo['fieldname']]); ?>" placeholder="<?php echo ($vo["setting"]["tips"]); ?>"><?php break;?>
             ...
             <?php case "editor": ?><script type="text/plain" id="extend_<?php echo ($vo["fieldname"]); ?>" name="extend[<?php echo ($vo["fieldname"]); ?>]"><?php echo ($data['setting']['extend'][$vo['fieldname']]); ?></script>
                 <?php echo \Form::editor('extend_'.$vo['fieldname'], 'basic', MODULE_NAME); break; endswitch;?>
